...
function SWEP:SecondaryAttack()
    ...
    owner:LagCompensation(true)
        ...
        -- local tgt, spos, sdest, trace = self.Weapon:MeleeTrace()
...
function SWEP:ShotTele()
    ...
    if IsValid( self.Weapon.Prop ) and self.Weapon.Prop.Tele then -- TODO: den hinteren Teil vielleicht wieder entfernen
